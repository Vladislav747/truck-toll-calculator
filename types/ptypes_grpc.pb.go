...
type AggregatorClient interface {
	...
	GetInvoice(ctx context.Context, in *GetInvoiceRequest, opts ...grpc.CallOption) (*None, error)
}
...
func (c *aggregatorClient) GetInvoice(ctx context.Context, in *GetInvoiceRequest, opts ...grpc.CallOption) (*None, error) {
	out := new(None)
...
type AggregatorServer interface {
	...
	GetInvoice(context.Context, *GetInvoiceRequest) (*None, error)
...
func (UnimplementedAggregatorServer) GetInvoice(context.Context, *GetInvoiceRequest) (*None, error) {
